...
type PageDocumentDataSlicesSlice = ContentIndexSlice | TechlistSlice;
...
export interface ContentIndexSliceDefaultPrimary {
  ...
  /**
   * Fall Back Image field in *ContentIndex → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.default.primary.fall_back_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
